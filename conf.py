...
BLOG_AUTHOR = "Vinicius Agostini"  # (translatable)
BLOG_TITLE = "Programming Bits"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://viagostini.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://viagostini.github.io/"
BLOG_EMAIL = "vinicius.agostini19@gmail.com"
BLOG_DESCRIPTION = (
    "Personal blog powered by Nikola static site generator"  # (translatable)
)
